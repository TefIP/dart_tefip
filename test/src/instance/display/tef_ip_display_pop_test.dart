...
void main() {
  group('TefIPDisplayPop', () {
    late TefIPDisplayPop displayPop;
    late MockHttpClient kHttpClient;

    setUp(() {
      kHttpClient = MockHttpClient();
      displayPop = TefIPDisplayPop();
    });
    ...
    test('should return SuccessResponseModel on success', () async {
      final expectedUrl = TefIpUrlBuilder.build(TefIPEndpoints.displayPop);
      ...
      final result = await displayPop.post(
        client: kHttpClient,
      );
