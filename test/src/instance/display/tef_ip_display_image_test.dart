...
void main() {
  group('TefIPDisplayImage', () {
    late TefIPDisplayImage displayImage;
    late MockHttpClient kHttpClient;

    setUp(() {
      kHttpClient = MockHttpClient();
      displayImage = TefIPDisplayImage();
    });
    ...
    test('should return SuccessResponseModel on success', () async {
      final expectedUrl = TefIpUrlBuilder.build(TefIPEndpoints.displayImage);
      ...
      final result = await displayImage.post(
        imageData: kImage,
        client: kHttpClient,
      );
