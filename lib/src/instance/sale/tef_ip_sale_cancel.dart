...
/// Endpoint responsible for canceling the current sale.
///
/// Performs an HTTP `POST` request to `/sale/cancel`
...
@immutable
@protected
interface class TefIPSaleCancel implements EndpointInterface {
  /// Fixed endpoint path.
  @override
  String get endpoint => TefIPEndpoints.saleCancel;

  /// Cancels the current sale.
  ///
  /// - [params] optional display parameters shown after cancellation.
