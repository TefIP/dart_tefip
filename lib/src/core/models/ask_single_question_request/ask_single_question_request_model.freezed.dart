...
AskSingleQuestionRequestModel _$AskSingleQuestionRequestModelFromJson(
  ...
  return _AskSingleQuestionModel.fromJson(json);
}

/// @nodoc
mixin _$AskSingleQuestionRequestModel {
  AskParametersModel get parameters;
  AskQuestionModel get question;

  /// Create a copy of AskSingleQuestionRequestModel
  /// with the given fields replaced by the non-null parameter values.
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  $AskSingleQuestionRequestModelCopyWith<AskSingleQuestionRequestModel>
      get copyWith => _$AskSingleQuestionRequestModelCopyWithImpl<
              AskSingleQuestionRequestModel>(
          this as AskSingleQuestionRequestModel, _$identity);
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is AskSingleQuestionRequestModel &&
...
abstract mixin class $AskSingleQuestionRequestModelCopyWith<$Res> {
  factory $AskSingleQuestionRequestModelCopyWith(
          AskSingleQuestionRequestModel value,
          $Res Function(AskSingleQuestionRequestModel) _then) =
      _$AskSingleQuestionRequestModelCopyWithImpl;
  @useResult
  $Res call({AskParametersModel parameters, AskQuestionModel question});
...
extension AskSingleQuestionRequestModelPatterns
    on AskSingleQuestionRequestModel {
  ...
  TResult maybeMap<TResult extends Object?>(
    TResult Function(_AskSingleQuestionModel value)? $default, {
  ...
  TResult maybeWhen<TResult extends Object?>(
    TResult Function(AskParametersModel parameters, AskQuestionModel question)?
        $default, {
    required TResult orElse(),
  }) {
    final _that = this;
    switch (_that) {
      case _AskSingleQuestionModel() when $default != null:
        return $default(_that.parameters, _that.question);
      case _:
        return orElse();
    }
  }
...
class _AskSingleQuestionModel implements AskSingleQuestionRequestModel {
  const _AskSingleQuestionModel(
      {required this.parameters, required this.question});
  factory _AskSingleQuestionModel.fromJson(Map<String, dynamic> json) =>
      _$AskSingleQuestionModelFromJson(json);

  @override
  final AskParametersModel parameters;
  @override
  final AskQuestionModel question;
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  _$AskSingleQuestionModelCopyWith<_AskSingleQuestionModel> get copyWith =>
      __$AskSingleQuestionModelCopyWithImpl<_AskSingleQuestionModel>(
          this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$AskSingleQuestionModelToJson(
      this,
    );
  }
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is _AskSingleQuestionModel &&
            (identical(other.parameters, parameters) ||
                other.parameters == parameters) &&
            (identical(other.question, question) ||
                other.question == question));
...
/// @nodoc
abstract mixin class _$AskSingleQuestionModelCopyWith<$Res>
    implements $AskSingleQuestionRequestModelCopyWith<$Res> {
  factory _$AskSingleQuestionModelCopyWith(_AskSingleQuestionModel value,
          $Res Function(_AskSingleQuestionModel) _then) =
      __$AskSingleQuestionModelCopyWithImpl;
  @override
  @useResult
  $Res call({AskParametersModel parameters, AskQuestionModel question});
