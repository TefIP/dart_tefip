...
mixin _$SuccessResponseModel {
  ...
  $SuccessResponseModelCopyWith<SuccessResponseModel> get copyWith =>
      _$SuccessResponseModelCopyWithImpl<SuccessResponseModel>(
          this as SuccessResponseModel, _$identity);
...
abstract mixin class $SuccessResponseModelCopyWith<$Res> {
  factory $SuccessResponseModelCopyWith(SuccessResponseModel value,
          $Res Function(SuccessResponseModel) _then) =
      _$SuccessResponseModelCopyWithImpl;
  @useResult
...
extension SuccessResponseModelPatterns on SuccessResponseModel {
  ...
  TResult maybeMap<TResult extends Object?>(
    TResult Function(_SuccessResponseModel value)? $default, {
...
class _SuccessResponseModel implements SuccessResponseModel {
  ...
  factory _SuccessResponseModel.fromJson(Map<String, dynamic> json) =>
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  _$SuccessResponseModelCopyWith<_SuccessResponseModel> get copyWith =>
      __$SuccessResponseModelCopyWithImpl<_SuccessResponseModel>(
          this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$SuccessResponseModelToJson(
      this,
    );
  }
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is _SuccessResponseModel &&
            (identical(other.message, message) || other.message == message));
  }
...
/// @nodoc
abstract mixin class _$SuccessResponseModelCopyWith<$Res>
    implements $SuccessResponseModelCopyWith<$Res> {
  factory _$SuccessResponseModelCopyWith(_SuccessResponseModel value,
          $Res Function(_SuccessResponseModel) _then) =
      __$SuccessResponseModelCopyWithImpl;
  @override
  @useResult
  $Res call({String message});
}
