...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,id,code,description,canceled,quantity,unitPrice,discount,addition,total,additionalInfo);
...
as double?,addition: freezed == addition ? _self.addition : addition // ignore: cast_nullable_to_non_nullable
...
@override final  double? addition;
