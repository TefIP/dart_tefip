...
mixin _$StatusModel {
  ...
  @override
  int get hashCode =>
      Object.hash(runtimeType, status, uptimeSeconds, startedAt);
...
abstract mixin class $StatusModelCopyWith<$Res> {
  ...
  @useResult
  $Res call({String status, int uptimeSeconds, String startedAt});
}
...
extension StatusModelPatterns on StatusModel {
  ...
  TResult maybeWhen<TResult extends Object?>(
    TResult Function(String status, int uptimeSeconds, String startedAt)?
        $default, {
    required TResult orElse(),
  }) {
    final _that = this;
    switch (_that) {
      case _StatusModel() when $default != null:
        return $default(_that.status, _that.uptimeSeconds, _that.startedAt);
      case _:
        return orElse();
    }
  }
