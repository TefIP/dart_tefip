...
mixin _$TransactionRequestModel {
 ...
 String? get referenceId;@JsonKey(name: 'tPag') TefIPTransactionType get type; double get amount; int get installments; TefIPInstallmentType get installmentType;@TefIPDetailsConverter() Map<String, dynamic>? get details;
...
@useResult
$Res call({
 String? referenceId,@JsonKey(name: 'tPag') TefIPTransactionType type, double amount, int installments, TefIPInstallmentType installmentType,@TefIPDetailsConverter() Map<String, dynamic>? details
});
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String? referenceId, @JsonKey(name: 'tPag')  TefIPTransactionType type,  double amount,  int installments,  TefIPInstallmentType installmentType, @TefIPDetailsConverter()  Map<String, dynamic>? details)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _TransactionRequestModel() when $default != null:
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String? referenceId, @JsonKey(name: 'tPag')  TefIPTransactionType type,  double amount,  int installments,  TefIPInstallmentType installmentType, @TefIPDetailsConverter()  Map<String, dynamic>? details)  $default,) {final _that = this;
switch (_that) {
case _TransactionRequestModel():
return $default(_that.referenceId,_that.type,_that.amount,_that.installments,_that.installmentType,_that.details);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String? referenceId, @JsonKey(name: 'tPag')  TefIPTransactionType type,  double amount,  int installments,  TefIPInstallmentType installmentType, @TefIPDetailsConverter()  Map<String, dynamic>? details)?  $default,) {final _that = this;
switch (_that) {
case _TransactionRequestModel() when $default != null:
return $default(_that.referenceId,_that.type,_that.amount,_that.installments,_that.installmentType,_that.details);case _:
  return null;
...
class _TransactionRequestModel implements TransactionRequestModel {
  const _TransactionRequestModel({this.referenceId = null, @JsonKey(name: 'tPag') this.type = TefIPTransactionType.unknown, this.amount = 0, this.installments = 1, this.installmentType = TefIPInstallmentType.single, @TefIPDetailsConverter() final  Map<String, dynamic>? details}): _details = details;
...
@override@JsonKey(name: 'tPag') final  TefIPTransactionType type;
