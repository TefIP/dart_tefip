...
mixin _$TransactionRequestModel {
  ...
  $TransactionRequestModelCopyWith<TransactionRequestModel> get copyWith =>
      _$TransactionRequestModelCopyWithImpl<TransactionRequestModel>(
          this as TransactionRequestModel, _$identity);
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is TransactionRequestModel &&
...
abstract mixin class $TransactionRequestModelCopyWith<$Res> {
  factory $TransactionRequestModelCopyWith(TransactionRequestModel value,
          $Res Function(TransactionRequestModel) _then) =
      _$TransactionRequestModelCopyWithImpl;
  @useResult
  $Res call(
      {String? referenceId,
      @JsonKey(name: 'tPag') TefIPTransactionType type,
      double amount,
      int installments,
...
extension TransactionRequestModelPatterns on TransactionRequestModel {
  ...
  TResult maybeMap<TResult extends Object?>(
    TResult Function(_TransactionRequestModel value)? $default, {
  ...
  TResult maybeWhen<TResult extends Object?>(
    ...
    switch (_that) {
      case _TransactionRequestModel() when $default != null:
        return $default(_that.referenceId, _that.type, _that.amount,
            _that.installments, _that.installmentType, _that.details);
      case _:
        return orElse();
    }
  }
...
class _TransactionRequestModel implements TransactionRequestModel {
  const _TransactionRequestModel(
      {this.referenceId = null,
      @JsonKey(name: 'tPag') this.type = TefIPTransactionType.unknown,
      this.amount = 0,
      this.installments = 1,
      this.installmentType = TefIPInstallmentType.single,
      @TefIPDetailsConverter() final Map<String, dynamic>? details})
      : _details = details;
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  _$TransactionRequestModelCopyWith<_TransactionRequestModel> get copyWith =>
      __$TransactionRequestModelCopyWithImpl<_TransactionRequestModel>(
          this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$TransactionRequestModelToJson(
      this,
    );
  }
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is _TransactionRequestModel &&
            (identical(other.referenceId, referenceId) ||
                other.referenceId == referenceId) &&
            (identical(other.type, type) || other.type == type) &&
            (identical(other.amount, amount) || other.amount == amount) &&
...
/// @nodoc
abstract mixin class _$TransactionRequestModelCopyWith<$Res>
    implements $TransactionRequestModelCopyWith<$Res> {
  factory _$TransactionRequestModelCopyWith(_TransactionRequestModel value,
          $Res Function(_TransactionRequestModel) _then) =
      __$TransactionRequestModelCopyWithImpl;
  @override
  @useResult
  $Res call(
      {String? referenceId,
