...
mixin _$LogModel {
  int get id;
  TefIPLogLevel get level;
  TefIPLogSource get source;
  String get message;
  String? get details;
  ...
  @override
  int get hashCode =>
      Object.hash(runtimeType, id, level, source, message, details, createdAt);
...
extension LogModelPatterns on LogModel {
  ...
  TResult maybeWhen<TResult extends Object?>(
    ...
    switch (_that) {
      case _LogModel() when $default != null:
        return $default(_that.id, _that.level, _that.source, _that.message,
            _that.details, _that.createdAt);
      case _:
        return orElse();
    }
  }
...
class _LogModel implements LogModel {
  ...
  final int id;
  @override
  final TefIPLogLevel level;
  @override
  final TefIPLogSource source;
  @override
