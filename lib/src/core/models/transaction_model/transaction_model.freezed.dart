...
mixin _$TransactionModel {
 ...
 String? get referenceId;@TefIPTransactionTypeConverter() TefIPTransactionType get type; TefIPTransactionStatus get transactionStatus; TefIPInstallmentType get installmentType; double get amount; int get installments; String? get nsu; String? get cnpj; String? get cAut; String? get tBand; String? get tPag; String? get txid; String? get acquirer;@TefIPUnixDateTimeConverter() DateTime? get createdAt;@TefIPUnixDateTimeConverter() DateTime? get updatedAt;@TefIPDetailsConverter() Map<String, dynamic>? get paymentDetails;@TefIPDetailsConverter() Map<String, dynamic>? get reversalDetails;
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,referenceId,type,transactionStatus,installmentType,amount,installments,nsu,cnpj,cAut,tBand,tPag,txid,acquirer,createdAt,updatedAt,const DeepCollectionEquality().hash(paymentDetails),const DeepCollectionEquality().hash(reversalDetails));

@override
String toString() {
  return 'TransactionModel(referenceId: $referenceId, type: $type, transactionStatus: $transactionStatus, installmentType: $installmentType, amount: $amount, installments: $installments, nsu: $nsu, cnpj: $cnpj, cAut: $cAut, tBand: $tBand, tPag: $tPag, txid: $txid, acquirer: $acquirer, createdAt: $createdAt, updatedAt: $updatedAt, paymentDetails: $paymentDetails, reversalDetails: $reversalDetails)';
}
...
@useResult
$Res call({
 String? referenceId,@TefIPTransactionTypeConverter() TefIPTransactionType type, TefIPTransactionStatus transactionStatus, TefIPInstallmentType installmentType, double amount, int installments, String? nsu, String? cnpj, String? cAut, String? tBand, String? tPag, String? txid, String? acquirer,@TefIPUnixDateTimeConverter() DateTime? createdAt,@TefIPUnixDateTimeConverter() DateTime? updatedAt,@TefIPDetailsConverter() Map<String, dynamic>? paymentDetails,@TefIPDetailsConverter() Map<String, dynamic>? reversalDetails
});
...
/// Create a copy of TransactionModel
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? referenceId = freezed,Object? type = null,Object? transactionStatus = null,Object? installmentType = null,Object? amount = null,Object? installments = null,Object? nsu = freezed,Object? cnpj = freezed,Object? cAut = freezed,Object? tBand = freezed,Object? tPag = freezed,Object? txid = freezed,Object? acquirer = freezed,Object? createdAt = freezed,Object? updatedAt = freezed,Object? paymentDetails = freezed,Object? reversalDetails = freezed,}) {
...
switch (_that) {
case _TransactionModel() when $default != null:
return $default(_that.referenceId,_that.type,_that.transactionStatus,_that.installmentType,_that.amount,_that.installments,_that.nsu,_that.cnpj,_that.cAut,_that.tBand,_that.tPag,_that.txid,_that.acquirer,_that.createdAt,_that.updatedAt,_that.paymentDetails,_that.reversalDetails);case _:
  return orElse();
...
@override final  String? tBand;
@override final  String? tPag;
@override final  String? txid;
@override final  String? acquirer;
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,referenceId,type,transactionStatus,installmentType,amount,installments,nsu,cnpj,cAut,tBand,tPag,txid,acquirer,createdAt,updatedAt,const DeepCollectionEquality().hash(_paymentDetails),const DeepCollectionEquality().hash(_reversalDetails));
