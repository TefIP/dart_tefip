...
mixin _$SaleStartRequestModel {
 ...
 String? get customerDocument; String? get customerName; String? get sellerName; String? get additionalInfo; num? get total;
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,customerDocument,customerName,sellerName,additionalInfo,total);

@override
String toString() {
  return 'SaleStartRequestModel(customerDocument: $customerDocument, customerName: $customerName, sellerName: $sellerName, additionalInfo: $additionalInfo, total: $total)';
}
...
@useResult
$Res call({
 String? customerDocument, String? customerName, String? sellerName, String? additionalInfo, num? total
});
...
/// Create a copy of SaleStartRequestModel
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? customerDocument = freezed,Object? customerName = freezed,Object? sellerName = freezed,Object? additionalInfo = freezed,Object? total = freezed,}) {
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String? customerDocument,  String? customerName,  String? sellerName,  String? additionalInfo,  num? total)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _SaleStartRequestModel() when $default != null:
return $default(_that.customerDocument,_that.customerName,_that.sellerName,_that.additionalInfo,_that.total);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String? customerDocument,  String? customerName,  String? sellerName,  String? additionalInfo,  num? total)  $default,) {final _that = this;
switch (_that) {
case _SaleStartRequestModel():
return $default(_that.customerDocument,_that.customerName,_that.sellerName,_that.additionalInfo,_that.total);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String? customerDocument,  String? customerName,  String? sellerName,  String? additionalInfo,  num? total)?  $default,) {final _that = this;
switch (_that) {
case _SaleStartRequestModel() when $default != null:
return $default(_that.customerDocument,_that.customerName,_that.sellerName,_that.additionalInfo,_that.total);case _:
  return null;
...
class _SaleStartRequestModel implements SaleStartRequestModel {
  const _SaleStartRequestModel({this.customerDocument, this.customerName, this.sellerName, this.additionalInfo, this.total});
...
/// Create a copy of SaleStartRequestModel
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? customerDocument = freezed,Object? customerName = freezed,Object? sellerName = freezed,Object? additionalInfo = freezed,Object? total = freezed,}) {
