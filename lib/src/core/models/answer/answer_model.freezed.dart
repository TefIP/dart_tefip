...
mixin _$AnswerModel {
  int get id;
  String get value;
  @JsonKey(readValue: _readDisplayValue)
...
abstract mixin class $AnswerModelCopyWith<$Res> {
  ...
  $Res call(
      {int id,
      String value,
      @JsonKey(readValue: _readDisplayValue) String displayValue});
}
...
extension AnswerModelPatterns on AnswerModel {
  ...
  TResult maybeWhen<TResult extends Object?>(
    TResult Function(int id, String value,
            @JsonKey(readValue: _readDisplayValue) String displayValue)?
        $default, {
    required TResult orElse(),
  }) {
    ...
    switch (_that) {
      case _AnswerModel() when $default != null:
        return $default(_that.id, _that.value, _that.displayValue);
      case _:
        return orElse();
    }
  }
...
class _AnswerModel implements AnswerModel {
  const _AnswerModel(
      {required this.id,
      required this.value,
      @JsonKey(readValue: _readDisplayValue) required this.displayValue});
