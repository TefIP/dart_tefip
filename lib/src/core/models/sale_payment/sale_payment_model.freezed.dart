...
mixin _$SalePaymentModel {
 ...
 String? get id;@JsonKey(name: 'tPag')@TefIPTransactionTypeConverter() TefIPSalePaymentType get type; String? get description; double get value; String? get additionalInfo;
...
@useResult
$Res call({
 String? id,@JsonKey(name: 'tPag')@TefIPTransactionTypeConverter() TefIPSalePaymentType type, String? description, double value, String? additionalInfo
});
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String? id, @JsonKey(name: 'tPag')@TefIPTransactionTypeConverter()  TefIPSalePaymentType type,  String? description,  double value,  String? additionalInfo)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _SalePaymentModel() when $default != null:
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String? id, @JsonKey(name: 'tPag')@TefIPTransactionTypeConverter()  TefIPSalePaymentType type,  String? description,  double value,  String? additionalInfo)  $default,) {final _that = this;
switch (_that) {
case _SalePaymentModel():
return $default(_that.id,_that.type,_that.description,_that.value,_that.additionalInfo);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String? id, @JsonKey(name: 'tPag')@TefIPTransactionTypeConverter()  TefIPSalePaymentType type,  String? description,  double value,  String? additionalInfo)?  $default,) {final _that = this;
switch (_that) {
case _SalePaymentModel() when $default != null:
return $default(_that.id,_that.type,_that.description,_that.value,_that.additionalInfo);case _:
  return null;
...
class _SalePaymentModel implements SalePaymentModel {
  const _SalePaymentModel({this.id, @JsonKey(name: 'tPag')@TefIPTransactionTypeConverter() this.type = TefIPSalePaymentType.unknown, this.description, required this.value, this.additionalInfo});
  factory _SalePaymentModel.fromJson(Map<String, dynamic> json) => _$SalePaymentModelFromJson(json);

@override final  String? id;
@override@JsonKey(name: 'tPag')@TefIPTransactionTypeConverter() final  TefIPSalePaymentType type;
