...
mixin _$SaleActionRequestModel {
  ...
  String? get buttonCloseText;
  int get messageInterval;

  /// Create a copy of SaleActionRequestModel
  /// with the given fields replaced by the non-null parameter values.
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  $SaleActionRequestModelCopyWith<SaleActionRequestModel> get copyWith =>
      _$SaleActionRequestModelCopyWithImpl<SaleActionRequestModel>(
          this as SaleActionRequestModel, _$identity);
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is SaleActionRequestModel &&
            ...
            (identical(other.buttonCloseText, buttonCloseText) ||
                other.buttonCloseText == buttonCloseText) &&
            (identical(other.messageInterval, messageInterval) ||
                other.messageInterval == messageInterval));
  }

  @JsonKey(includeFromJson: false, includeToJson: false)
  @override
  int get hashCode => Object.hash(runtimeType, message, showMessage,
      showCloseButton, buttonCloseText, messageInterval);
...
abstract mixin class $SaleActionRequestModelCopyWith<$Res> {
  factory $SaleActionRequestModelCopyWith(SaleActionRequestModel value,
          $Res Function(SaleActionRequestModel) _then) =
      _$SaleActionRequestModelCopyWithImpl;
  @useResult
  $Res call(
      {String? message,
      bool showMessage,
...
class _$SaleActionRequestModelCopyWithImpl<$Res>
  ...
  $Res call({
    ...
    Object? buttonCloseText = freezed,
    Object? messageInterval = null,
  }) {
    return _then(_self.copyWith(
      ...
      showCloseButton: null == showCloseButton
          ...
          : showCloseButton // ignore: cast_nullable_to_non_nullable
              as bool,
      buttonCloseText: freezed == buttonCloseText
          ? _self.buttonCloseText
          : buttonCloseText // ignore: cast_nullable_to_non_nullable
              as String?,
      messageInterval: null == messageInterval
          ? _self.messageInterval
          : messageInterval // ignore: cast_nullable_to_non_nullable
              as int,
    ));
  }
}
...
extension SaleActionRequestModelPatterns on SaleActionRequestModel {
  ...
  TResult maybeMap<TResult extends Object?>(
    TResult Function(_SaleActionRequestModel value)? $default, {
  ...
  TResult maybeWhen<TResult extends Object?>(
    TResult Function(String? message, bool showMessage, bool showCloseButton,
            String? buttonCloseText, int messageInterval)?
        $default, {
    required TResult orElse(),
  }) {
    final _that = this;
    switch (_that) {
      case _SaleActionRequestModel() when $default != null:
        return $default(_that.message, _that.showMessage, _that.showCloseButton,
            _that.buttonCloseText, _that.messageInterval);
      case _:
        return orElse();
    }
  }
...
class _SaleActionRequestModel implements SaleActionRequestModel {
  const _SaleActionRequestModel(
      {this.message,
      this.showMessage = true,
      this.showCloseButton = true,
      this.buttonCloseText,
      this.messageInterval = 3000});
  factory _SaleActionRequestModel.fromJson(Map<String, dynamic> json) =>
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  _$SaleActionRequestModelCopyWith<_SaleActionRequestModel> get copyWith =>
      __$SaleActionRequestModelCopyWithImpl<_SaleActionRequestModel>(
          this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$SaleActionRequestModelToJson(
      this,
    );
  }
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is _SaleActionRequestModel &&
            (identical(other.message, message) || other.message == message) &&
            (identical(other.showMessage, showMessage) ||
                other.showMessage == showMessage) &&
            (identical(other.showCloseButton, showCloseButton) ||
...
/// @nodoc
abstract mixin class _$SaleActionRequestModelCopyWith<$Res>
    implements $SaleActionRequestModelCopyWith<$Res> {
  factory _$SaleActionRequestModelCopyWith(_SaleActionRequestModel value,
          $Res Function(_SaleActionRequestModel) _then) =
      __$SaleActionRequestModelCopyWithImpl;
  @override
  @useResult
  $Res call(
      {String? message,
