...
mixin _$DisplayCarouselRequestModel {
  @TefIPImagesConverter()
  List<String> get images;
  int get intervalMs;
  TefIPCarouselTransition get transition;
  ...
  $DisplayCarouselRequestModelCopyWith<DisplayCarouselRequestModel>
      get copyWith => _$DisplayCarouselRequestModelCopyWithImpl<
              DisplayCarouselRequestModel>(
          this as DisplayCarouselRequestModel, _$identity);
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is DisplayCarouselRequestModel &&
...
abstract mixin class $DisplayCarouselRequestModelCopyWith<$Res> {
  factory $DisplayCarouselRequestModelCopyWith(
          DisplayCarouselRequestModel value,
          $Res Function(DisplayCarouselRequestModel) _then) =
      _$DisplayCarouselRequestModelCopyWithImpl;
  @useResult
  $Res call(
      {@TefIPImagesConverter() List<String> images,
      int intervalMs,
      TefIPCarouselTransition transition,
...
extension DisplayCarouselRequestModelPatterns on DisplayCarouselRequestModel {
  ...
  TResult maybeMap<TResult extends Object?>(
    TResult Function(_DisplayCarouselRequestModel value)? $default, {
  ...
  TResult maybeWhen<TResult extends Object?>(
    ...
    switch (_that) {
      case _DisplayCarouselRequestModel() when $default != null:
        return $default(_that.images, _that.intervalMs, _that.transition,
            _that.backgroundColor, _that.showCloseButton);
      case _:
        return orElse();
    }
  }
...
class _DisplayCarouselRequestModel implements DisplayCarouselRequestModel {
  const _DisplayCarouselRequestModel(
      {@TefIPImagesConverter() required final List<String> images,
      this.intervalMs = 3000,
      this.transition = TefIPCarouselTransition.fade,
      required this.backgroundColor,
      this.showCloseButton = false})
      : _images = images;
  factory _DisplayCarouselRequestModel.fromJson(Map<String, dynamic> json) =>
  ...
  @override
  @JsonKey()
  final TefIPCarouselTransition transition;
  @override
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  _$DisplayCarouselRequestModelCopyWith<_DisplayCarouselRequestModel>
      get copyWith => __$DisplayCarouselRequestModelCopyWithImpl<
          _DisplayCarouselRequestModel>(this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$DisplayCarouselRequestModelToJson(
      this,
    );
  }
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is _DisplayCarouselRequestModel &&
...
/// @nodoc
abstract mixin class _$DisplayCarouselRequestModelCopyWith<$Res>
    implements $DisplayCarouselRequestModelCopyWith<$Res> {
  factory _$DisplayCarouselRequestModelCopyWith(
          _DisplayCarouselRequestModel value,
          $Res Function(_DisplayCarouselRequestModel) _then) =
      __$DisplayCarouselRequestModelCopyWithImpl;
  @override
  @useResult
  $Res call(
      {@TefIPImagesConverter() List<String> images,
